...
import com.goshine.player.po.OnlineVideo;
import com.goshine.player.ui.base.ArrayAdapter;
import com.goshine.player.ui.helper.XmlReaderHelper;
...
public class FragmentOnline extends FragmentBase implements OnItemClickListener {
	...
	private final static ArrayList<OnlineVideo> root = new ArrayList<OnlineVideo>();// 电视直播
	private ArrayList<OnlineVideo> tvs;
	private final static ArrayList<OnlineVideo> videos = new ArrayList<OnlineVideo>();// 视频网站
	private int level = 1;
